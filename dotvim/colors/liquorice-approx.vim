...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || (&term =~? "^konsole" && s:old_kde())
    ...
    CSAHi UniteSelectedLine term=NONE cterm=NONE ctermbg=53 ctermfg=fg gui=NONE guibg=#301020 guifg=fg
    ...
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=246 gui=NONE guibg=bg guifg=#929292
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi IndentGuidesOdd term=NONE cterm=NONE ctermbg=232 ctermfg=fg gui=NONE guibg=#0a0a0a guifg=fg
    CSAHi IndentGuidesEven term=NONE cterm=NONE ctermbg=232 ctermfg=fg gui=NONE guibg=#0d0d0d guifg=fg
    CSAHi UniteSelectedLine term=NONE cterm=NONE ctermbg=52 ctermfg=fg gui=NONE guibg=#301020 guifg=fg
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi UniteSelectedLine term=NONE cterm=NONE ctermbg=16 ctermfg=fg gui=NONE guibg=#301020 guifg=fg
    ...
    CSAHi Comment term=bold cterm=NONE ctermbg=bg ctermfg=83 gui=NONE guibg=bg guifg=#929292
