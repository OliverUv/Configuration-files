...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || (&term =~? "^konsole" && s:old_kde())
    ...
    CSAHi IndentGuidesOdd term=NONE cterm=NONE ctermbg=252 ctermfg=fg gui=NONE guibg=#d0d0d0 guifg=fg
    ...
    CSAHi NeomakeMessageSignDefault term=NONE cterm=NONE ctermbg=252 ctermfg=60 gui=NONE guibg=#d0d0d0 guifg=#304050
    CSAHi NeomakeWarningSignDefault term=NONE cterm=NONE ctermbg=252 ctermfg=125 gui=NONE guibg=#d0d0d0 guifg=#99004c
    ...
    CSAHi IndentGuidesEven term=NONE cterm=NONE ctermbg=254 ctermfg=fg gui=NONE guibg=#e5e5e5 guifg=fg
    ...
    CSAHi NeomakeErrorSignDefault term=NONE cterm=NONE ctermbg=252 ctermfg=234 gui=NONE guibg=#d0d0d0 guifg=#191919
    CSAHi NeomakeInfoSignDefault term=NONE cterm=NONE ctermbg=252 ctermfg=72 gui=NONE guibg=#d0d0d0 guifg=#2e8b57
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    ...
    CSAHi SneakPluginTarget term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi SneakPluginScope term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi NeomakeMessageSignDefault term=NONE cterm=NONE ctermbg=252 ctermfg=66 gui=NONE guibg=#d0d0d0 guifg=#304050
    CSAHi NeomakeWarningSignDefault term=NONE cterm=NONE ctermbg=252 ctermfg=162 gui=NONE guibg=#d0d0d0 guifg=#99004c
    CSAHi UniteSelectedLine term=NONE cterm=NONE ctermbg=252 ctermfg=fg gui=NONE guibg=#d0d0d0 guifg=fg
    CSAHi javaScriptAjaxProperties term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi SneakPluginTarget term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi SneakPluginScope term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi NeomakeMessageSignDefault term=NONE cterm=NONE ctermbg=252 ctermfg=59 gui=NONE guibg=#d0d0d0 guifg=#304050
    CSAHi NeomakeWarningSignDefault term=NONE cterm=NONE ctermbg=252 ctermfg=89 gui=NONE guibg=#d0d0d0 guifg=#99004c
    CSAHi UniteSelectedLine term=NONE cterm=NONE ctermbg=252 ctermfg=fg gui=NONE guibg=#d0d0d0 guifg=fg
    CSAHi javaScriptAjaxProperties term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi NeomakeErrorSignDefault term=NONE cterm=NONE ctermbg=252 ctermfg=234 gui=NONE guibg=#d0d0d0 guifg=#191919
    CSAHi NeomakeInfoSignDefault term=NONE cterm=NONE ctermbg=252 ctermfg=29 gui=NONE guibg=#d0d0d0 guifg=#2e8b57
    CSAHi SyntasticWarningLine term=NONE cterm=NONE ctermbg=255 ctermfg=fg gui=NONE guibg=#f0f0f0 guifg=fg
    CSAHi htmlH1 term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi htmlLink term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi IndentGuidesOdd term=NONE cterm=NONE ctermbg=86 ctermfg=fg gui=NONE guibg=#d0d0d0 guifg=fg
    ...
    CSAHi SneakPluginTarget term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi SneakPluginScope term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi NeomakeMessageSignDefault term=NONE cterm=NONE ctermbg=86 ctermfg=17 gui=NONE guibg=#d0d0d0 guifg=#304050
    CSAHi NeomakeWarningSignDefault term=NONE cterm=NONE ctermbg=86 ctermfg=33 gui=NONE guibg=#d0d0d0 guifg=#99004c
    ...
    CSAHi IndentGuidesEven term=NONE cterm=NONE ctermbg=87 ctermfg=fg gui=NONE guibg=#e5e5e5 guifg=fg
    ...
    CSAHi NeomakeErrorSignDefault term=NONE cterm=NONE ctermbg=86 ctermfg=80 gui=NONE guibg=#d0d0d0 guifg=#191919
    CSAHi NeomakeInfoSignDefault term=NONE cterm=NONE ctermbg=86 ctermfg=21 gui=NONE guibg=#d0d0d0 guifg=#2e8b57
